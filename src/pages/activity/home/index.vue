  ...
  <div class="">
    ...
    <div v-if="activity">
      ...
      <div class="flex-wrp flex-middle bg-white pt10 pb20">
        <template v-if="activity&&activity.deadline&&moment().isBefore(activity.deadline)">
        ...
        <template v-else-if="(activity&&!activity.deadline)||moment().isAfter(activity.deadline)">
