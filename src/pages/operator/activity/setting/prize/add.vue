<template>
  <div class="pb60">
    ...
    <group label-width="2.1rem" label-margin-right="2em" label-align="left" gutter=".3rem">
      <x-input title="活动名称:" placeholder="请输入活动" required v-model="prize.name"/>
      ...
      <datetime title="奖品有效期" class="color2" v-model="prize.endTime" format="YYYY-MM-DD HH:mm"
      ...
      <x-textarea title="奖品详情:" v-model="prize.details" :show-counter="false" :rows="3"></x-textarea>
    </group>


    <div class="plr20 pb10 pt30">
      <div class="size26 color13 plr30 ptb10 border-radius5 text-center" :style="{border:'1px solid #29d6bf'}">添加图片
      </div>
    </div>
    <div class="plr20 ptb10">
      <div class="size26 color13 plr30 ptb10 border-radius5 text-center" :style="{border:'1px solid #29d6bf'}">添加文本
      </div>
    </div>
    <div class="plr20 ptb10">
