<template>
    <div v-if="showTabBar" class="fixed-bottom weui-tabbar" >
        <router-link :to="n.link" class="weui-tabbar__item" active-class="weui-bar__item_on" :exact="n.link == '/'" v-for="(n,i) in config.navs" :key="i">
...
<script>
    ...
    import {http, isWechat, isAndroid, wx} from 'utils/index'
    export default {
      computed: {
        ...mapState({
